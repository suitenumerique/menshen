"""
Menshen: createsuperuser management command.

This command overriding the "createsuperuser" command to allow creating users
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Note that if the user exists upgrade the existing user to superuser status.
        """
