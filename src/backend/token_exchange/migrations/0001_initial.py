# Generated by Django 6.0.3 on 2026-04-16 16:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='token_exchange_credentials', to='token_exchange.serviceprovider')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_service', models.ForeignKey(help_text='Service provider initiating the token exchange', on_delete=django.db.models.deletion.CASCADE, related_name='exchange_out', to='token_exchange.serviceprovider', verbose_name='Source Service')),
                ('target_service', models.ForeignKey(help_text='Service provider receiving the exchanged token', on_delete=django.db.models.deletion.CASCADE, related_name='exchange_in', to='token_exchange.serviceprovider', verbose_name='Target Service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='action_grants', to='token_exchange.serviceprovider', verbose_name='Target Service')),
            ],
            options={
