    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Unique identifier for this action scope, starts with 'action:'", max_length=255, unique=True, validators=[apps.tx.models.validate_action_scope_name], verbose_name='Action Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jwt_kid', models.CharField(blank=True, db_index=True, help_text='The key ID used to sign the JWT token', max_length=255, verbose_name='JWT Key ID')),
                ('subject_sub', models.CharField(blank=True, db_index=True, help_text='The subject identifier (sub) from the introspection', max_length=255, verbose_name='Subject Sub')),
                ('subject_email', models.EmailField(blank=True, db_index=True, help_text='The subject email from the introspection', max_length=255, verbose_name='Subject Email')),
                ('audiences', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), default=list, help_text='The audiences for this token (RFC 8693 supports multiple)', verbose_name='Audiences')),
                ...
                ('actor_token', models.TextField(blank=True, help_text='The actor token for delegation (RFC 8693)', verbose_name='Actor Token')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['subject_sub', 'created_at'], name='menshen_tx__subject_5baea5_idx'), models.Index(fields=['subject_email', 'created_at'], name='menshen_tx__subject_27d94f_idx'), models.Index(fields=['expires_at', 'revoked_at'], name='menshen_tx__expires_e46c84_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='token_exchange_credentials', to='tx.serviceprovider')),
            ],
            options={
                'verbose_name': 'service provider credentials',
                'verbose_name_plural': 'service providers credentials',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_service', models.ForeignKey(help_text='Service provider initiating the token exchange', on_delete=django.db.models.deletion.CASCADE, related_name='exchange_out', to='tx.serviceprovider', verbose_name='Source Service')),
                ('target_service', models.ForeignKey(help_text='Service provider receiving the exchanged token', on_delete=django.db.models.deletion.CASCADE, related_name='exchange_in', to='tx.serviceprovider', verbose_name='Target Service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('throttle_rate', models.CharField(blank=True, help_text="Optional throttle rate (e.g., '5/h', '100/day')", max_length=255, verbose_name='Throttle Rate')),
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grants', to='tx.actionscope', verbose_name='Action Scope')),
                ('target_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='action_grants', to='tx.serviceprovider', verbose_name='Target Service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissions', to='tx.actionscope', verbose_name='Action Scope')),
                ('rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='action_permissions', to='tx.tokenexchangerule', verbose_name='Exchange Rule')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('throttle_rate', models.CharField(blank=True, help_text="Optional throttle rate (e.g., '5/h', '100/day')", max_length=255, verbose_name='Throttle Rate')),
                ('rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scope_grants', to='tx.tokenexchangerule', verbose_name='Exchange Rule')),
            ],
            options={
