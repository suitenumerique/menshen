...
ALLOWED_HOSTS = [
    "localhost",
    "menshen-playground-target",
    "target.playground.menshen.lasuite.localhost",
]
...
LOGIN_REDIRECT_URL = "http://target.playground.menshen.lasuite.localhost:9003/"
LOGIN_REDIRECT_URL_FAILURE = "http://target.playground.menshen.lasuite.localhost:9003/"
LOGOUT_REDIRECT_URL = "http://target.playground.menshen.lasuite.localhost:9003/"
OIDC_REDIRECT_ALLOWED_HOSTS = "target.playground.menshen.lasuite.localhost:9003/"

# Token exchange
OIDC_TX_TOKEN_ENDPOINT = "http://menshen-backend:8000/auth/token/exchange/"
OIDC_TX_INTROSPECTION_ENDPOINT = "http://menshen-backend:8000/auth/token/introspect/"
