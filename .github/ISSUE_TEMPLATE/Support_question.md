...
Please make sure you have read our [main Readme](https://github.com/suitenumerique/menshen).

Also make sure it was not already answered in [an open or close issue](https://github.com/suitenumerique/menshen/issues).
