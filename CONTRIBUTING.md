...
To get started with the project, please refer to the [README.md](https://github.com/suitenumerique/menshen/blob/main/README.md) for detailed instructions on how to run the project locally.
...
We use a [GitHub Project](https://github.com/orgs/numerique-gouv/projects/) in order to prioritize our workload. 
...
- ✨(frontend) add shiny login form #321
```
